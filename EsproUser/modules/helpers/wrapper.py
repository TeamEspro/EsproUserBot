                ...
                button = [
                    [
                        InlineKeyboardButton(
                            "💥 Deploy Espro Userbot ✨",
                            url=f"https://github.com/TeamEspro/EsproUserBot"
                        )
                    ]
                ]
                    ...
                    results=[
                        (
                            InlineQueryResultPhoto(
                                photo_url=f"https://telegra.ph/file/e40bad038936f01b11317.jpg",
                                title="🥀 Espro Userbot ✨",
                                thumb_url=f"https://telegra.ph/file/e40bad038936f01b11317.jpg",
                                description=f"🌷 Deploy Your Own Espro-Userbot 🌿...",
                                caption=f"<b>🥀 Welcome » To » Espro 🌷\n✅ Userbot {__version__} ✨...</b>",
                        ...
                        (
                            InlineQueryResultArticle(
                                ...
                                input_message_content=InputTextMessageContent(
                                    f"||**🥀 Please, Deploy Your Own Espro Userbot❗...\n\nRepo:** <i>https://github.com/TeamEspro/EsproUserBot/</i>||"
                                ),
                            )
                        )
                    ],
